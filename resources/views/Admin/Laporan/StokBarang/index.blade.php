    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row mb-4">
                    <div class="col-12">
                        <label for="" class="fw-bold">Cari Barang</label>
                    </div>
                    <div class="col-md-3">
...
<script>
        ...
        table = $('#table-1').DataTable({
            ...
            "ajax": {
                ...
                "data": function(d) {
                    ...
                    d.nmbarang = $('input[name="nmbarang"]').val();
                }
            },
    ...
    function print() {
        var tglawal = $('input[name="tglawal"]').val();
        var tglakhir = $('input[name="tglakhir"]').val();
        var barang = $('input[name="nmbarang"]').val();
        window.open(
            "{{route('lap-sb.print')}}?tglawal=" + tglawal + "&tglakhir=" + tglakhir + "&barang=" + barang,
            '_blank'
        );
    ...
    function pdf() {
        ...
        var barang = $('input[name="nmbarang"]').val();
        window.open(
            "{{route('lap-sb.pdf')}}?tglawal=" + tglawal + "&tglakhir=" + tglakhir + "&barang=" + barang,
            '_blank'
        );
