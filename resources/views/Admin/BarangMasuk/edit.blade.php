            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="picU" class="form-label">PIC <span class="text-danger">*</span></label>
                            <input type="text" name="picU" class="form-control" placeholder="">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
    ...
    <script>
        ...
        function checkFormU() {
            ...
            if (tglmasuk == "") {
                ...
                validasi('PIC wajib di pilih!', 'warning');
                $("input[name='picU']").addClass('is-invalid');
                setLoadingU(false);
                return false;
        ...
        function resetValidU() {
            ...
            $("input[name='picU']").removeClass('is-invalid');
