...
MySQL - 10.4.28-MariaDB : Database - db_inventoryweb1
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`db_inventoryweb1` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;

USE `db_inventoryweb1`;
...
CREATE TABLE `tbl_barangkeluar` (
  ...
  `bk_pic` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`bk_id`)
...
insert  into `tbl_barangkeluar`(`bk_id`,`bk_kode`,`barang_kode`,`bk_tanggal`,`bk_tujuan`,`bk_jumlah`,`bk_pic`,`created_at`,`updated_at`) values 
(4,'BK-1700227511733','BRG-1669390220236','2023-12-01','Solo','50','Herdiana Dede','2023-11-17 13:25:32','2023-11-17 13:25:40');
...
CREATE TABLE `tbl_barangmasuk` (
  ...
  `bm_pic` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`bm_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
insert  into `tbl_barangmasuk`(`bm_id`,`bm_kode`,`barang_kode`,`customer_id`,`bm_tanggal`,`bm_jumlah`,`bm_pic`,`created_at`,`updated_at`) values 
(4,'BM-1700227174922','BRG-1669390220236','2','2023-11-30','100','Dede Herdiana','2023-11-17 13:19:55','2023-11-17 13:20:04');
